...
| **Knowledge graph** | 222,540 nodes · **6,428,359 edges** · 17 node types · 22 relation types |
...
kg = pd.read_parquet("data/kg/kg_edges.parquet")       # 6,428,359 rows
...
222,540 nodes, 6,428,359 edges, 17 node types, 22 relation types.
